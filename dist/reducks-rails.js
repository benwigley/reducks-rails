(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["reducks-rails"] = factory();
	else
		root["reducks-rails"] = factory();
...
/*!**********************!*\
  !*** ./src/index.js ***!
  \**********************/
/*! exports provided: normalize, normalizedMerge, actionTypeModifiers, registerCollections, entitySelectors, setEntitiesAction, setEntitiesFromStateAction, ReducksBaseCollection, initReducksRailsMiddleware */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _libs_normalize__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./libs/normalize */ "./src/libs/normalize.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "normalize", function() { return _libs_normalize__WEBPACK_IMPORTED_MODULE_0__["default"]; });

/* harmony import */ var _libs_normalizedMerge__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./libs/normalizedMerge */ "./src/libs/normalizedMerge.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "normalizedMerge", function() { return _libs_normalizedMerge__WEBPACK_IMPORTED_MODULE_1__["default"]; });

/* harmony import */ var _libs_entitySelectors__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./libs/entitySelectors */ "./src/libs/entitySelectors.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "entitySelectors", function() { return _libs_entitySelectors__WEBPACK_IMPORTED_MODULE_2__["default"]; });

/* harmony import */ var _libs_actionTypeModifiers__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./libs/actionTypeModifiers */ "./src/libs/actionTypeModifiers.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "actionTypeModifiers", function() { return _libs_actionTypeModifiers__WEBPACK_IMPORTED_MODULE_3__["default"]; });

/* harmony import */ var _reducks_registerCollections__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./reducks/registerCollections */ "./src/reducks/registerCollections.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "registerCollections", function() { return _reducks_registerCollections__WEBPACK_IMPORTED_MODULE_4__["default"]; });

/* harmony import */ var _reducks_ReducksBaseCollection__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./reducks/ReducksBaseCollection */ "./src/reducks/ReducksBaseCollection.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "setEntitiesAction", function() { return _reducks_ReducksBaseCollection__WEBPACK_IMPORTED_MODULE_5__["setEntities"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "setEntitiesFromStateAction", function() { return _reducks_ReducksBaseCollection__WEBPACK_IMPORTED_MODULE_5__["setEntitiesFromState"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "ReducksBaseCollection", function() { return _reducks_ReducksBaseCollection__WEBPACK_IMPORTED_MODULE_5__["ReducksBaseCollection"]; });

/* harmony import */ var _middleware_initReducksRailsMiddleware__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./middleware/initReducksRailsMiddleware */ "./src/middleware/initReducksRailsMiddleware.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "initReducksRailsMiddleware", function() { return _middleware_initReducksRailsMiddleware__WEBPACK_IMPORTED_MODULE_6__["default"]; });
...
/***/ "./src/libs/actionTypeModifiers.js":
/*!*****************************************!*\
  !*** ./src/libs/actionTypeModifiers.js ***!
  \*****************************************/
...
function initApi(apiConfig = {}) {
  ...
  apiConfig = Object(lodash__WEBPACK_IMPORTED_MODULE_3__["defaults"])(apiConfig, {
    ...
    baseUrl: '/',
    axiosConfig: {},
    // user may supply config directly to axios
  ...
  const transformRequest = [...axios__WEBPACK_IMPORTED_MODULE_0___default.a.defaults.transformRequest, (data, headers) => {
    // Convert from camelCase to snake_case
    if (apiConfig.snakeCaseServerData) {
      return humps__WEBPACK_IMPORTED_MODULE_1___default.a.decamelizeKeys(data);
    }
  ...
  const transformResponse = [...axios__WEBPACK_IMPORTED_MODULE_0___default.a.defaults.transformResponse, (data, headers) => {
    // Convert from Rails snake_case to JS camelCase
    if (apiConfig.camelCaseClientData) {
      return humps__WEBPACK_IMPORTED_MODULE_1___default.a.camelizeKeys(data);
    }
  ...
  const api = axios__WEBPACK_IMPORTED_MODULE_0___default.a.create(axiosConfig); // Give the developer access to the final api object
...
/* harmony default export */ __webpack_exports__["default"] = (initApi);

/***/ }),

/***/ "./src/libs/entitySelectors.js":
/*!*************************************!*\
  !*** ./src/libs/entitySelectors.js ***!
  \*************************************/
/*! exports provided: getEntitiesArray, where, findWhere, entitiesMap, entitiesFilter, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getEntitiesArray", function() { return getEntitiesArray; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "entitiesMap", function() { return entitiesMap; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "entitiesFilter", function() { return entitiesFilter; });
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! lodash */ "./node_modules/lodash/lodash.js");
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(lodash__WEBPACK_IMPORTED_MODULE_0__);


function validateResource(resource) {
  if (!Object(lodash__WEBPACK_IMPORTED_MODULE_0__["isObject"])(resource)) {
    throw new TypeError("Invalid resource object");
  }

  if (!Object(lodash__WEBPACK_IMPORTED_MODULE_0__["isObject"])(resource.entities) || !Object(lodash__WEBPACK_IMPORTED_MODULE_0__["isArray"])(resource.ids)) {
    throw new TypeError("Invalid resource object, should be in the format { entities: {...}, ids: [...] }");
  }
}

const getEntitiesArray = resource => {
  validateResource(resource);
  return Object(lodash__WEBPACK_IMPORTED_MODULE_0__["map"])(resource.ids, id => resource.entities[id]);
};
const where = (resource, matchAttrs) => {
  return Object(lodash__WEBPACK_IMPORTED_MODULE_0__["filter"])(getEntitiesArray(resource), matchAttrs);
};
const findWhere = (resource, matchAttrs) => {
  return Object(lodash__WEBPACK_IMPORTED_MODULE_0__["find"])(getEntitiesArray(resource), matchAttrs);
};
const entitiesMap = (resource, mapper) => {
  return Object(lodash__WEBPACK_IMPORTED_MODULE_0__["map"])(getEntitiesArray(resource), mapper);
};
const entitiesFilter = (resource, predicate) => {
  return Object(lodash__WEBPACK_IMPORTED_MODULE_0__["filter"])(getEntitiesArray(resource), predicate);
};
/* harmony default export */ __webpack_exports__["default"] = ({
  getEntitiesArray,
  where,
...
/* harmony import */ var _normalizedMerge__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./normalizedMerge */ "./src/libs/normalizedMerge.js");
...
/* harmony import */ var _logger__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./logger */ "./src/libs/logger.js");




let count; // Check the schema for any nested collections that we haven't been
...
function hydrateSchema(schema, mainSchema) {
  if (mainSchema[schema.collection] && mainSchema[schema.collection].nested) {
    ...
    schema.nested = Object(lodash__WEBPACK_IMPORTED_MODULE_2__["unionWith"])(schema.nested, mainSchema[schema.collection].nested, (schemaA, schemaB) => {
...
function processNestedCollections(withSchema, entitiesArray, baseCollectionsLookup, mainSchema, hardFail = false) {
  count += 1;
  let schema = Object(lodash__WEBPACK_IMPORTED_MODULE_2__["cloneDeep"])(withSchema);
  if (!schema.collection) throw new Error(`Normalize.collection must exist`);
  if (!schema.key) schema.key = schema.collection;

  if (!Object(lodash__WEBPACK_IMPORTED_MODULE_2__["isArray"])(schema.nested)) {
  ...
  schema.nested.forEach(nestedSchema => {
    ...
    for (let index = 0; index < entitiesArray.length; index++) {
      ...
      if (Object(lodash__WEBPACK_IMPORTED_MODULE_2__["isNil"])(entitiesArray[index][nestedSchema.key])) {
        if (hardFail) {
          ...
          entitiesArray[index][nestedSchema.key] = pluralize__WEBPACK_IMPORTED_MODULE_1___default.a.isPlural(nestedSchema.key) ? [] : {};
          entitiesArray[index][`${pluralize__WEBPACK_IMPORTED_MODULE_1___default.a.singular(nestedSchema.key)}Ids`] = [];
        }
      } else {
        const isNestedItemAnArray = Object(lodash__WEBPACK_IMPORTED_MODULE_2__["isArray"])(entitiesArray[index][nestedSchema.key]);
        ...
        if (nestedSchema.nested) {
          ...
          processNestedCollections(Object(lodash__WEBPACK_IMPORTED_MODULE_2__["cloneDeep"])(nestedSchema), nestedSchemasArray, baseCollectionsLookup, mainSchema);
        } // Update the base collection with any new items found


        baseCollectionsLookup[nestedSchema.collection] = Object(_normalizedMerge__WEBPACK_IMPORTED_MODULE_0__["default"])(baseCollectionsLookup[nestedSchema.collection], {
          entities: Object(lodash__WEBPACK_IMPORTED_MODULE_2__["keyBy"])(nestedSchemasArray, 'id'),
          ids: Object(lodash__WEBPACK_IMPORTED_MODULE_2__["map"])(nestedSchemasArray, e => e.id)
        }, false); // Clean Up
        // Replace the nested collection with a list of ids

        if (isNestedItemAnArray) {
          entitiesArray[index][`${pluralize__WEBPACK_IMPORTED_MODULE_1___default.a.singular(nestedSchema.key)}Ids`] = Object(lodash__WEBPACK_IMPORTED_MODULE_2__["map"])(nestedSchemasArray, e => e.id);
        }
...
function normalize(baseEntitiesArray, baseSchema, mainSchema) {
  ...
  if (!Object(lodash__WEBPACK_IMPORTED_MODULE_2__["isObject"])(baseSchema)) {
  ...
  if (!Object(lodash__WEBPACK_IMPORTED_MODULE_2__["isObject"])(mainSchema)) {
  ...
  count = 0; // This is the base collection lookup, in the format:
  // { recipeItems: { entities, ids }, recipeProjects, { entities, ids }, ... }

  let baseCollectionsLookup = {};
  let clonedBaseEntitiesArray = Object(lodash__WEBPACK_IMPORTED_MODULE_2__["cloneDeep"])(baseEntitiesArray);

  if (baseSchema.key && clonedBaseEntitiesArray[baseSchema.key]) {
    clonedBaseEntitiesArray = clonedBaseEntitiesArray[baseSchema.key];
  }

  if (!Object(lodash__WEBPACK_IMPORTED_MODULE_2__["isArray"])(clonedBaseEntitiesArray)) {
  ...
  baseCollectionsLookup[baseSchema.collection] = {
    entities: Object(lodash__WEBPACK_IMPORTED_MODULE_2__["keyBy"])(clonedBaseEntitiesArray, 'id'),
    ids: Object(lodash__WEBPACK_IMPORTED_MODULE_2__["map"])(clonedBaseEntitiesArray, e => e.id)
  };
  _logger__WEBPACK_IMPORTED_MODULE_3__["default"].debug(`Normalize: Processed ${count} nested collections in collection:${baseSchema.collection}`);
  _logger__WEBPACK_IMPORTED_MODULE_3__["default"].debug(`Normalize: Final baseCollectionsLookup keys`, Object.keys(baseCollectionsLookup));
  return baseCollectionsLookup;
}

/***/ }),

/***/ "./src/libs/normalizedMerge.js":
/*!*************************************!*\
  !*** ./src/libs/normalizedMerge.js ***!
  \*************************************/
/*! exports provided: normalizedMerge, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "normalizedMerge", function() { return normalizedMerge; });
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! lodash */ "./node_modules/lodash/lodash.js");
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(lodash__WEBPACK_IMPORTED_MODULE_0__);
...
function normalizedMerge(existingState, newState) {
  return Object(lodash__WEBPACK_IMPORTED_MODULE_0__["mergeWith"])(Object(lodash__WEBPACK_IMPORTED_MODULE_0__["cloneDeep"])(existingState), newState, (existingStateProperty, newStateProperty, statePropertyKey) => {
    // The 'ids' properties of state should be merge together, not replaced.
    if (statePropertyKey === 'ids' && Object(lodash__WEBPACK_IMPORTED_MODULE_0__["isArray"])(existingStateProperty)) {
      if (Object(lodash__WEBPACK_IMPORTED_MODULE_0__["isArray"])(newStateProperty)) {
        return Object(lodash__WEBPACK_IMPORTED_MODULE_0__["union"])(existingStateProperty, newStateProperty);
      ...
      return Object(lodash__WEBPACK_IMPORTED_MODULE_0__["mergeWith"])(existingStateProperty, newStateProperty, (existingEntityProperty, newEntityProperty, entityPropertyKey) => {
        if (entityPropertyKey.substr(entityPropertyKey.length - 3) == 'Ids' && Object(lodash__WEBPACK_IMPORTED_MODULE_0__["isArray"])(existingEntityProperty)) {
          if (Object(lodash__WEBPACK_IMPORTED_MODULE_0__["isArray"])(newEntityProperty)) {
            return Object(lodash__WEBPACK_IMPORTED_MODULE_0__["union"])(existingEntityProperty.concat(newEntityProperty));
          }
    ...
    if (Object(lodash__WEBPACK_IMPORTED_MODULE_0__["isArray"])(existingStateProperty) && !newStateProperty) {
      // Usually we override the old attribute with the new one,
      // but in the case of arrays (id arrays), we want to keep that
      // data intact or it would ruin our normalized data state.
      return existingStateProperty;
...
/* harmony default export */ __webpack_exports__["default"] = (normalizedMerge);

/***/ }),

/***/ "./src/libs/pathJoin.js":
/*!******************************!*\
  !*** ./src/libs/pathJoin.js ***!
  \******************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ((parts, sep) => {
  var separator = sep || '/';
...
/* harmony default export */ __webpack_exports__["default"] = (asyncDispatchMiddleware);

/***/ }),

/***/ "./src/middleware/initReducksRailsMiddleware.js":
/*!******************************************************!*\
  !*** ./src/middleware/initReducksRailsMiddleware.js ***!
  \******************************************************/
/*! exports provided: default */
...
/***/ "./src/middleware/initReduxApiMiddleware.js":
/*!**************************************************!*\
  !*** ./src/middleware/initReduxApiMiddleware.js ***!
  \**************************************************/
/*! exports provided: parseResult, initReduxApiMiddleware, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "parseResult", function() { return parseResult; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initReduxApiMiddleware", function() { return initReduxApiMiddleware; });
...
/* harmony import */ var _libs_logger__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../libs/logger */ "./src/libs/logger.js");
...
const parseResult = (json, inConfig, action = {}) => {
  let dataParser = inConfig.parse;
  let setMetaData = inConfig.setMetaData;
  let data;
  let metaData = {}; // Parse functions from actions override config
...
const initReduxApiMiddleware = inConfig => {
  ...
  const reduxApiMiddleware = store => next => action => {
    ...
    action.reducksRailsConfig = inConfig; // Here we check whether an "api" or "nodeApi" key:object
    ...
    const requestParams = {
      ...
      data: humps__WEBPACK_IMPORTED_MODULE_0___default.a.decamelizeKeys(action.api.data),
      params: humps__WEBPACK_IMPORTED_MODULE_0___default.a.decamelizeKeys(action.api.params)
    }; // Allow the baseUrl to be changed for specific requests

    if (action.baseUrl) {
      requestParams.baseURL = action.baseUrl;
    }
...
/* harmony default export */ __webpack_exports__["default"] = (initReduxApiMiddleware);

/***/ }),

/***/ "./src/reducks/ReducksBaseCollection.js":
/*!**********************************************!*\
  !*** ./src/reducks/ReducksBaseCollection.js ***!
  \**********************************************/
/*! exports provided: SET_ENTITIES, SET_ENTITIES_FROM_STATE, setEntities, setEntitiesFromState, ReducksBaseCollection, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SET_ENTITIES", function() { return SET_ENTITIES; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SET_ENTITIES_FROM_STATE", function() { return SET_ENTITIES_FROM_STATE; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "setEntities", function() { return setEntities; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "setEntitiesFromState", function() { return setEntitiesFromState; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ReducksBaseCollection", function() { return ReducksBaseCollection; });
/* harmony import */ var _libs_logger__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../libs/logger */ "./src/libs/logger.js");
/* harmony import */ var _libs_normalize__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../libs/normalize */ "./src/libs/normalize.js");
/* harmony import */ var _libs_pathJoin__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../libs/pathJoin */ "./src/libs/pathJoin.js");
/* harmony import */ var _libs_actionTypeModifiers__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../libs/actionTypeModifiers */ "./src/libs/actionTypeModifiers.js");
/* harmony import */ var _libs_normalizedMerge__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../libs/normalizedMerge */ "./src/libs/normalizedMerge.js");
...
const SET_ENTITIES = 'reducksRails/entities/SET_ENTITIES';
const SET_ENTITIES_FROM_STATE = 'reducksRails/entities/SET_ENTITIES_FROM_STATE'; // Global Action Creators

function setEntities(normalizedData) {
  return {
    type: SET_ENTITIES,
    normalizedData
  };
}
function setEntitiesFromState(state) {
  return {
...
let ReducksBaseCollection = /*#__PURE__*/function () {
  function ReducksBaseCollection() {
    _classCallCheck(this, ReducksBaseCollection);
    ...
    this.orderBy = null;
    this.reverseOrder = false; // Bind all functions that make use of this
    ...
    const methodsToBind = ['reducer', 'processApiRequest', 'processApiSuccess', 'processApiFailure', 'index', 'show', 'create', 'update', 'destroy'];
    methodsToBind.forEach(methodName => {
      this[methodName] = this[methodName].bind(this);
    }); // Request Action Type Modifiers

    this.requestTypeModifier = _libs_actionTypeModifiers__WEBPACK_IMPORTED_MODULE_3__["default"].requestTypeModifier;
    this.successTypeModifier = _libs_actionTypeModifiers__WEBPACK_IMPORTED_MODULE_3__["default"].successTypeModifier;
    this.failureTypeModifier = _libs_actionTypeModifiers__WEBPACK_IMPORTED_MODULE_3__["default"].failureTypeModifier;
  }

  _createClass(ReducksBaseCollection, [{
    key: "getCollection",
    value: function getCollection() {
      return this.getCollectionSchema().collection;
    }
  }, {
    key: "getControllerPath",
    value: function getControllerPath(append = '') {
      ...
      return Object(_libs_pathJoin__WEBPACK_IMPORTED_MODULE_2__["default"])([path, append]);
    }
  }, {
    key: "getCollectionSchema",
    value: function getCollectionSchema() {
    ...
    key: "orderIds",
    value: function orderIds(ids, entities) {
      if (this.orderBy) {
        return Object(lodash__WEBPACK_IMPORTED_MODULE_5__["sortBy"])(ids, id => {
    ...
    key: "getNormalizedDataFrom",
    value: function getNormalizedDataFrom(entityOrEntities) {
      return Object(_libs_normalize__WEBPACK_IMPORTED_MODULE_1__["default"])(entityOrEntities, this.getCollectionSchema(), this.getMainSchema());
    }
  }, {
    key: "reducer",
    value: function reducer(state, action = {}) {
      ...
      switch (action.type) {
        ...
        case SET_ENTITIES:
          ...
          finalStateBeforeOrdering = Object(_libs_normalizedMerge__WEBPACK_IMPORTED_MODULE_4__["default"])(state, {
        ...
        case SET_ENTITIES_FROM_STATE:
          ...
          _libs_logger__WEBPACK_IMPORTED_MODULE_0__["default"].debug(`${SET_ENTITIES_FROM_STATE}:${collection}`, action.normalizedData[collection]);
          finalStateBeforeOrdering = Object(_libs_normalizedMerge__WEBPACK_IMPORTED_MODULE_4__["default"])(state, action.normalizedData[collection]);
          return { ...finalStateBeforeOrdering,
            ids: this.orderIds(finalStateBeforeOrdering.ids, finalStateBeforeOrdering.entities)
          };
        //
        ...
        case this.successTypeModifier(`${this.getControllerPath()}.${UPDATE}`):
          ...
          return this.processApiSuccess({
            state: { ...state,
              isUpdatingEntityId: null
            },
            action // Example of transforming the final state returned from this.processApiSuccess
        ...
        case this.successTypeModifier(`${this.getControllerPath()}.${DESTROY}`):
          return this.processApiSuccess({
            state: { ...this.removeEntityById(state, action.id),
    ...
    key: "processApiRequest",
    value: function processApiRequest({
      state,
      action
    }) {
      _libs_logger__WEBPACK_IMPORTED_MODULE_0__["default"].log(`ReducksBaseCollection:${this.constructor.name}:processApiRequest`);
      return { ...state,
        isLoading: true
      };
    }
  }, {
    key: "processApiSuccess",
    value: function processApiSuccess({
      state,
      action,
      dataTransformer
    }) {
      ...
      if (!action.payload.data.id && !Object(lodash__WEBPACK_IMPORTED_MODULE_5__["isArray"])(action.payload.data)) {
        // An entity was probably deleted, but there might be other
        // models or collections of models, so check before continuing.
        if (action.payload.data && Object(lodash__WEBPACK_IMPORTED_MODULE_5__["isArray"])(this.getCollectionSchema().nested)) {
          this.getCollectionSchema().nested.forEach(nestedSchema => {
            ...
            if (action.payload.data[nestedSchema.key]) {
              ...
              const normalizedData = Object(_libs_normalize__WEBPACK_IMPORTED_MODULE_1__["default"])(action.payload.data[nestedSchema.key], relationsSchema, this.getMainSchema());
      ...
      const normalizedData = Object(_libs_normalize__WEBPACK_IMPORTED_MODULE_1__["default"])(action.payload.data, this.getCollectionSchema(), this.getMainSchema());
      action.asyncDispatch(setEntities(normalizedData)); // Fist, merge the newState into the old state

      let newState = Object(_libs_normalizedMerge__WEBPACK_IMPORTED_MODULE_4__["default"])(state, {
      ...
      const finalStateBeforeOrdering = Object(_libs_normalizedMerge__WEBPACK_IMPORTED_MODULE_4__["default"])(newState, dataTransformer(normalizedData, newState));
      return { ...finalStateBeforeOrdering,
        ids: this.orderIds(finalStateBeforeOrdering.ids, finalStateBeforeOrdering.entities)
      };
    }
  }, {
    key: "processApiFailure",
    value: function processApiFailure({
      state,
      action
    }) {
      _libs_logger__WEBPACK_IMPORTED_MODULE_0__["default"].log(`ReducksBaseCollection:${this.constructor.name}:processApiFailure`);
      return { ...state,
        isLoading: false,
    ...
    value: function removeEntityById(state, entityToDeleteId) {
      _libs_logger__WEBPACK_IMPORTED_MODULE_0__["default"].log(`ReducksBaseCollection:${this.constructor.name}:removeEntityById:${entityToDeleteId}`);
      return this.removeEntitiesById(state, [entityToDeleteId]);
    }
  }, {
    key: "removeEntitiesById",
    value: function removeEntitiesById(state, entityIdsToDelete) {
      _libs_logger__WEBPACK_IMPORTED_MODULE_0__["default"].log(`ReducksBaseCollection:${this.constructor.name}:removeEntityById:${entityIdsToDelete}`);
      let updatedEntities = {};
      let updatedIds = [];
...
/* harmony default export */ __webpack_exports__["default"] = (ReducksBaseCollection);
...
/* harmony default export */ __webpack_exports__["default"] = ((...collections) => {
  ...
  if (Object(lodash__WEBPACK_IMPORTED_MODULE_0__["isArray"])(collections[0])) {
