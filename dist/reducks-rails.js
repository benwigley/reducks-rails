...
/* harmony import */ var _normalizedMerge_ts__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./normalizedMerge.ts */ "./src/libs/normalizedMerge.ts");
  ...
  schema.nested.forEach(nestedSchema => {
    ...
    for (let index = 0; index < entitiesArray.length; index++) {
      ...
      if (typeof entitiesArray[index][nestedSchema.key] === 'undefined') {
        ...
        baseCollectionsLookup[nestedSchema.collection] = Object(_normalizedMerge_ts__WEBPACK_IMPORTED_MODULE_0__["default"])(baseCollectionsLookup[nestedSchema.collection], {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return normalizedMerge; });
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! lodash */ "./node_modules/lodash/lodash.js");
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(lodash__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _logger__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./logger */ "./src/libs/logger.js");
...
// }
//
function normalizedMerge(existingState, newState, shouldLog = false) {
  if (shouldLog) {
    _logger__WEBPACK_IMPORTED_MODULE_1__["default"].debug('-----------');
    _logger__WEBPACK_IMPORTED_MODULE_1__["default"].debug('normalizedMerge');
    _logger__WEBPACK_IMPORTED_MODULE_1__["default"].debug('existingState', existingState);
    _logger__WEBPACK_IMPORTED_MODULE_1__["default"].debug('newState', newState);
  }

  return Object(lodash__WEBPACK_IMPORTED_MODULE_0__["mergeWith"])(Object(lodash__WEBPACK_IMPORTED_MODULE_0__["cloneDeep"])(existingState), newState, function (existingStateProperty, newStateProperty, statePropertyKey) {
    if (shouldLog) {
      _logger__WEBPACK_IMPORTED_MODULE_1__["default"].debug('statePropertyKey', statePropertyKey);
      _logger__WEBPACK_IMPORTED_MODULE_1__["default"].debug('existingStateProperty', existingStateProperty);
      _logger__WEBPACK_IMPORTED_MODULE_1__["default"].debug('newStateProperty', newStateProperty);
      _logger__WEBPACK_IMPORTED_MODULE_1__["default"].debug('-----------');
    ...
    if (statePropertyKey === 'ids' && Object(lodash__WEBPACK_IMPORTED_MODULE_0__["isArray"])(existingStateProperty)) {
      ...
      return Object(lodash__WEBPACK_IMPORTED_MODULE_0__["mergeWith"])(existingStateProperty, newStateProperty, function (existingEntityProperty, newEntityProperty, entityPropertyKey) {
        if (entityPropertyKey.substr(entityPropertyKey.length - 3) == 'Ids') {// console.log("=================")
        ...
        if (entityPropertyKey.substr(entityPropertyKey.length - 3) == 'Ids' && Object(lodash__WEBPACK_IMPORTED_MODULE_0__["isArray"])(existingEntityProperty)) {
          if (Object(lodash__WEBPACK_IMPORTED_MODULE_0__["isArray"])(newEntityProperty)) return Object(lodash__WEBPACK_IMPORTED_MODULE_0__["union"])(existingEntityProperty.concat(newEntityProperty));
...
/*!**********************************************!*\
  !*** ./src/reducks/ReducksBaseCollection.js ***!
  \**********************************************/
/*! exports provided: SET_ENTITIES, SET_ENTITIES_FROM_OFFLINE_SYNC, REMOVE_ENTITIES_FROM_OFFLINE_SYNC, SET_ENTITIES_FROM_STORE, setEntities, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SET_ENTITIES", function() { return SET_ENTITIES; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SET_ENTITIES_FROM_OFFLINE_SYNC", function() { return SET_ENTITIES_FROM_OFFLINE_SYNC; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "REMOVE_ENTITIES_FROM_OFFLINE_SYNC", function() { return REMOVE_ENTITIES_FROM_OFFLINE_SYNC; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SET_ENTITIES_FROM_STORE", function() { return SET_ENTITIES_FROM_STORE; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "setEntities", function() { return setEntities; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return ReducksBaseCollection; });
/* harmony import */ var _libs_logger__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../libs/logger */ "./src/libs/logger.js");
/* harmony import */ var _libs_normalize_ts__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../libs/normalize.ts */ "./src/libs/normalize.ts");
...
/* harmony import */ var _libs_normalizedMerge_ts__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../libs/normalizedMerge.ts */ "./src/libs/normalizedMerge.ts");
...
const SET_ENTITIES_FROM_OFFLINE_SYNC = 'reducksRails/entities/SET_ENTITIES_FROM_OFFLINE_SYNC';
const REMOVE_ENTITIES_FROM_OFFLINE_SYNC = 'reducksRails/entities/REMOVE_ENTITIES_FROM_OFFLINE_SYNC';
const SET_ENTITIES_FROM_STORE = 'reducksRails/entities/SET_ENTITIES_FROM_STORE'; // Action Creators
...
class ReducksBaseCollection {
  ...
  processApiSuccess({
    ...
    const finalStateBeforeOrdering = Object(_libs_normalizedMerge_ts__WEBPACK_IMPORTED_MODULE_3__["default"])(newState, dataTransformer(normalizedData, newState));
    return { ...finalStateBeforeOrdering,
      ids: this.orderIds(finalStateBeforeOrdering.ids, finalStateBeforeOrdering.entities)
    };
  }
