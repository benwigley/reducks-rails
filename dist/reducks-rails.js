...
/*!**********************!*\
  !*** ./src/index.js ***!
  \**********************/
/*! exports provided: normalize, normalizedMerge, actionTypeModifiers, registerCollections, setEntitiesAction, setEntitiesFromStateAction, ReducksBaseCollection, initReducksRailsMiddleware */
...
/* harmony import */ var _libs_actionTypeModifiers__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./libs/actionTypeModifiers */ "./src/libs/actionTypeModifiers.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "actionTypeModifiers", function() { return _libs_actionTypeModifiers__WEBPACK_IMPORTED_MODULE_2__["default"]; });

/* harmony import */ var _reducks_registerCollections__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./reducks/registerCollections */ "./src/reducks/registerCollections.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "registerCollections", function() { return _reducks_registerCollections__WEBPACK_IMPORTED_MODULE_3__["default"]; });

/* harmony import */ var _reducks_ReducksBaseCollection__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./reducks/ReducksBaseCollection */ "./src/reducks/ReducksBaseCollection.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "setEntitiesAction", function() { return _reducks_ReducksBaseCollection__WEBPACK_IMPORTED_MODULE_4__["setEntities"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "setEntitiesFromStateAction", function() { return _reducks_ReducksBaseCollection__WEBPACK_IMPORTED_MODULE_4__["setEntitiesFromState"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "ReducksBaseCollection", function() { return _reducks_ReducksBaseCollection__WEBPACK_IMPORTED_MODULE_4__["ReducksBaseCollection"]; });

/* harmony import */ var _middleware_initReducksRailsMiddleware__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./middleware/initReducksRailsMiddleware */ "./src/middleware/initReducksRailsMiddleware.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "initReducksRailsMiddleware", function() { return _middleware_initReducksRailsMiddleware__WEBPACK_IMPORTED_MODULE_5__["default"]; });
...
/* harmony import */ var _libs_actionTypeModifiers__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../libs/actionTypeModifiers */ "./src/libs/actionTypeModifiers.js");
/* harmony import */ var _libs_normalizedMerge__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../libs/normalizedMerge */ "./src/libs/normalizedMerge.js");
...
const SET_ENTITIES_FROM_STATE = 'tjmer/entities/SET_ENTITIES_FROM_STATE'; // Action Creators
...
let ReducksBaseCollection = /*#__PURE__*/function () {
  function ReducksBaseCollection() {
    ...
    this.orderBy = null;
    this.reverseOrder = false; // Warning: Don't change these to use the modern function declaration
    //          e.g. () => {}
    //          It breaks things for some reason.

    this.reducer = this.reducer.bind(this);
    this.processApiSuccess = this.processApiSuccess.bind(this);
    this.processApiFailure = this.processApiFailure.bind(this); // Request Action Type Modifiers

    this.requestTypeModifier = _libs_actionTypeModifiers__WEBPACK_IMPORTED_MODULE_2__["default"].requestTypeModifier;
    this.successTypeModifier = _libs_actionTypeModifiers__WEBPACK_IMPORTED_MODULE_2__["default"].successTypeModifier;
    this.failureTypeModifier = _libs_actionTypeModifiers__WEBPACK_IMPORTED_MODULE_2__["default"].failureTypeModifier;
  }
  ...
  _createClass(ReducksBaseCollection, [{
    ...
    value: function orderIds(ids, entities) {
      if (this.orderBy) {
        return Object(lodash__WEBPACK_IMPORTED_MODULE_4__["sortBy"])(ids, id => {
    ...
    value: function reducer(state, action = {}) {
      ...
      switch (action.type) {
        ...
        case SET_ENTITIES:
          ...
          finalStateBeforeOrdering = Object(_libs_normalizedMerge__WEBPACK_IMPORTED_MODULE_3__["default"])(state, {
        ...
        case SET_ENTITIES_FROM_STATE:
          ...
          finalStateBeforeOrdering = Object(_libs_normalizedMerge__WEBPACK_IMPORTED_MODULE_3__["default"])(state, action.normalizedData[collection]);
          return { ...finalStateBeforeOrdering,
            ids: this.orderIds(finalStateBeforeOrdering.ids, finalStateBeforeOrdering.entities)
          };
      }
    ...
    value: function processApiSuccess({
        ...
        if (action.payload.response && Object(lodash__WEBPACK_IMPORTED_MODULE_4__["isArray"])(this.getCollectionSchema().nested)) {
          this.getCollectionSchema().nested.forEach(nestedSchema => {
            ...
            if (action.payload.response[nestedSchema.key]) {
              ...
              const normalizedData = Object(_libs_normalize__WEBPACK_IMPORTED_MODULE_1__["default"])(action.payload.response[nestedSchema.key], relationsSchema, this.getMainSchema());
      ...
      const normalizedData = Object(_libs_normalize__WEBPACK_IMPORTED_MODULE_1__["default"])(action.payload.response, this.getCollectionSchema(), this.getMainSchema());
      action.asyncDispatch(setEntities(normalizedData)); // Fist, merge the newState into the old state

      let newState = Object(_libs_normalizedMerge__WEBPACK_IMPORTED_MODULE_3__["default"])(state, {
      ...
      const finalStateBeforeOrdering = Object(_libs_normalizedMerge__WEBPACK_IMPORTED_MODULE_3__["default"])(newState, dataTransformer(normalizedData, newState));
      return { ...finalStateBeforeOrdering,
        ids: this.orderIds(finalStateBeforeOrdering.ids, finalStateBeforeOrdering.entities)
      };
    }
