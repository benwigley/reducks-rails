...
/* harmony import */ var humps__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! humps */ "./node_modules/humps/humps.js");
...
function initApi(apiConfig = {}) {
  ...
  apiConfig = lodash_defaults__WEBPACK_IMPORTED_MODULE_0___default()(apiConfig, {
    debug: false,
    baseUrl: '/',
    axiosConfig: {},
  ...
  const transformRequest = [...axios__WEBPACK_IMPORTED_MODULE_1___default.a.defaults.transformRequest, (data, headers) => {
    // Convert from camelCase to snake_case
    if (apiConfig.snakeCaseServerData) {
      return humps__WEBPACK_IMPORTED_MODULE_2___default.a.decamelizeKeys(data);
    }
  ...
  const transformResponse = [...axios__WEBPACK_IMPORTED_MODULE_1___default.a.defaults.transformResponse, (data, headers) => {
    // Convert from Rails snake_case to JS camelCase
    if (apiConfig.camelCaseClientData) {
      return humps__WEBPACK_IMPORTED_MODULE_2___default.a.camelizeKeys(data);
    }
  ...
  let axiosConfig = lodash_defaults__WEBPACK_IMPORTED_MODULE_0___default()(apiConfig.axiosConfig, {
    baseURL: apiConfig.baseUrl,
    withCredentials: false,
    // This threw an error when set to true
    timeout: 20000,
    headers: lodash_defaults__WEBPACK_IMPORTED_MODULE_0___default()(apiConfig.axiosConfig.headers || {}, {
      'Content-Type': 'application/json'
    }),
    responseType: 'json',
    transformRequest,
  ...
  const api = axios__WEBPACK_IMPORTED_MODULE_1___default.a.create(axiosConfig); // Give the developer access to the final api object
...
function validateResource(resource) {
  if (!lodash_isObject__WEBPACK_IMPORTED_MODULE_1___default()(resource)) {
    throw new TypeError("Invalid resource object");
  }

  if (!lodash_isObject__WEBPACK_IMPORTED_MODULE_1___default()(resource.entities) || !lodash_isArray__WEBPACK_IMPORTED_MODULE_0___default()(resource.ids)) {
...
const getEntitiesArray = resource => {
  ...
  return lodash_map__WEBPACK_IMPORTED_MODULE_4___default()(resource.ids, id => resource.entities[id]);
};
const where = (resource, matchAttrs) => {
  return lodash_filter__WEBPACK_IMPORTED_MODULE_3___default()(getEntitiesArray(resource), matchAttrs);
};
const findWhere = (resource, matchAttrs) => {
  return lodash_find__WEBPACK_IMPORTED_MODULE_2___default()(getEntitiesArray(resource), matchAttrs);
};
const entitiesMap = (resource, mapper) => {
  return lodash_map__WEBPACK_IMPORTED_MODULE_4___default()(getEntitiesArray(resource), mapper);
};
const entitiesFilter = (resource, predicate) => {
  return lodash_filter__WEBPACK_IMPORTED_MODULE_3___default()(getEntitiesArray(resource), predicate);
};
/* harmony default export */ __webpack_exports__["default"] = ({
  getEntitiesArray,
  where,
...
/* harmony import */ var lodash_isObject__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! lodash/isObject */ "./node_modules/lodash/isObject.js");
/* harmony import */ var lodash_isObject__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(lodash_isObject__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var lodash_unionWith__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! lodash/unionWith */ "./node_modules/lodash/unionWith.js");
/* harmony import */ var lodash_unionWith__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(lodash_unionWith__WEBPACK_IMPORTED_MODULE_2__);
...
/* harmony import */ var _normalizedMerge__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./normalizedMerge */ "./src/libs/normalizedMerge.js");
...
/* harmony import */ var _logger__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./logger */ "./src/libs/logger.js");
...
function hydrateSchema(schema, mainSchema) {
  if (mainSchema[schema.collection] && mainSchema[schema.collection].nested) {
    ...
    schema.nested = lodash_unionWith__WEBPACK_IMPORTED_MODULE_2___default()(schema.nested, mainSchema[schema.collection].nested, (schemaA, schemaB) => {
...
function processNestedCollections(withSchema, entitiesArray, baseCollectionsLookup, mainSchema, hardFail = false) {
  ...
  let schema = lodash_cloneDeep__WEBPACK_IMPORTED_MODULE_3___default()(withSchema);

  if (!schema.collection) throw new Error(`Normalize.collection must exist`);
  if (!schema.key) schema.key = schema.collection;

  if (!lodash_isArray__WEBPACK_IMPORTED_MODULE_4___default()(schema.nested)) {
  ...
  schema.nested.forEach(nestedSchema => {
    ...
    for (let index = 0; index < entitiesArray.length; index++) {
      ...
      if (lodash_isNil__WEBPACK_IMPORTED_MODULE_0___default()(entitiesArray[index][nestedSchema.key])) {
        if (hardFail) {
          ...
          entitiesArray[index][nestedSchema.key] = pluralize__WEBPACK_IMPORTED_MODULE_8___default.a.isPlural(nestedSchema.key) ? [] : {};
          entitiesArray[index][`${pluralize__WEBPACK_IMPORTED_MODULE_8___default.a.singular(nestedSchema.key)}Ids`] = [];
        }
      } else {
        const isNestedItemAnArray = lodash_isArray__WEBPACK_IMPORTED_MODULE_4___default()(entitiesArray[index][nestedSchema.key]);
        ...
        if (nestedSchema.nested) {
          ...
          processNestedCollections(lodash_cloneDeep__WEBPACK_IMPORTED_MODULE_3___default()(nestedSchema), nestedSchemasArray, baseCollectionsLookup, mainSchema);
        } // Update the base collection with any new items found


        baseCollectionsLookup[nestedSchema.collection] = Object(_normalizedMerge__WEBPACK_IMPORTED_MODULE_7__["default"])(baseCollectionsLookup[nestedSchema.collection], {
          entities: lodash_keyBy__WEBPACK_IMPORTED_MODULE_5___default()(nestedSchemasArray, 'id'),
          ids: lodash_map__WEBPACK_IMPORTED_MODULE_6___default()(nestedSchemasArray, e => e.id)
        }, false); // Clean Up
        // Replace the nested collection with a list of ids

        if (isNestedItemAnArray) {
          entitiesArray[index][`${pluralize__WEBPACK_IMPORTED_MODULE_8___default.a.singular(nestedSchema.key)}Ids`] = lodash_map__WEBPACK_IMPORTED_MODULE_6___default()(nestedSchemasArray, e => e.id);
        }
...
function normalize(baseEntitiesArray, baseSchema, mainSchema) {
  ...
  if (!lodash_isObject__WEBPACK_IMPORTED_MODULE_1___default()(baseSchema)) {
  ...
  if (!lodash_isObject__WEBPACK_IMPORTED_MODULE_1___default()(mainSchema)) {
  ...
  let clonedBaseEntitiesArray = lodash_cloneDeep__WEBPACK_IMPORTED_MODULE_3___default()(baseEntitiesArray);

  if (baseSchema.key && clonedBaseEntitiesArray[baseSchema.key]) {
    clonedBaseEntitiesArray = clonedBaseEntitiesArray[baseSchema.key];
  }

  if (!lodash_isArray__WEBPACK_IMPORTED_MODULE_4___default()(clonedBaseEntitiesArray)) {
  ...
  baseCollectionsLookup[baseSchema.collection] = {
    entities: lodash_keyBy__WEBPACK_IMPORTED_MODULE_5___default()(clonedBaseEntitiesArray, 'id'),
    ids: lodash_map__WEBPACK_IMPORTED_MODULE_6___default()(clonedBaseEntitiesArray, e => e.id)
  };
  _logger__WEBPACK_IMPORTED_MODULE_9__["default"].debug(`Normalize: Processed ${count} nested collections in collection:${baseSchema.collection}`);
  _logger__WEBPACK_IMPORTED_MODULE_9__["default"].debug(`Normalize: Final baseCollectionsLookup keys`, Object.keys(baseCollectionsLookup));
...
function normalizedMerge(existingState, newState) {
  return lodash_mergeWith__WEBPACK_IMPORTED_MODULE_2___default()(lodash_cloneDeep__WEBPACK_IMPORTED_MODULE_3___default()(existingState), newState, (existingStateProperty, newStateProperty, statePropertyKey) => {
    // The 'ids' properties of state should be merge together, not replaced.
    if (statePropertyKey === 'ids' && lodash_isArray__WEBPACK_IMPORTED_MODULE_1___default()(existingStateProperty)) {
      if (lodash_isArray__WEBPACK_IMPORTED_MODULE_1___default()(newStateProperty)) {
        return lodash_union__WEBPACK_IMPORTED_MODULE_0___default()(existingStateProperty, newStateProperty);
      ...
      return lodash_mergeWith__WEBPACK_IMPORTED_MODULE_2___default()(existingStateProperty, newStateProperty, (existingEntityProperty, newEntityProperty, entityPropertyKey) => {
        if (entityPropertyKey.substr(entityPropertyKey.length - 3) == 'Ids' && lodash_isArray__WEBPACK_IMPORTED_MODULE_1___default()(existingEntityProperty)) {
          if (lodash_isArray__WEBPACK_IMPORTED_MODULE_1___default()(newEntityProperty)) {
            return lodash_union__WEBPACK_IMPORTED_MODULE_0___default()(existingEntityProperty.concat(newEntityProperty));
          }
    ...
    if (lodash_isArray__WEBPACK_IMPORTED_MODULE_1___default()(existingStateProperty) && !newStateProperty) {
      // Usually we override the old attribute with the new one,
      // but in the case of arrays (id arrays), we want to keep that
      // data intact or it would ruin our normalized data state.
      return existingStateProperty;
...
/* harmony import */ var _libs_logger__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../libs/logger */ "./src/libs/logger.js");
/* harmony import */ var _libs_normalize__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../libs/normalize */ "./src/libs/normalize.js");
/* harmony import */ var _libs_pathJoin__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../libs/pathJoin */ "./src/libs/pathJoin.js");
/* harmony import */ var _libs_actionTypeModifiers__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../libs/actionTypeModifiers */ "./src/libs/actionTypeModifiers.js");
/* harmony import */ var _libs_normalizedMerge__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../libs/normalizedMerge */ "./src/libs/normalizedMerge.js");
...
let ReducksBaseCollection = /*#__PURE__*/function () {
  function ReducksBaseCollection() {
    ...
    this.requestTypeModifier = _libs_actionTypeModifiers__WEBPACK_IMPORTED_MODULE_5__["default"].requestTypeModifier;
    this.successTypeModifier = _libs_actionTypeModifiers__WEBPACK_IMPORTED_MODULE_5__["default"].successTypeModifier;
    this.failureTypeModifier = _libs_actionTypeModifiers__WEBPACK_IMPORTED_MODULE_5__["default"].failureTypeModifier;
  }
  ...
  _createClass(ReducksBaseCollection, [{
    ...
    value: function getControllerPath(append = '') {
      ...
      return Object(_libs_pathJoin__WEBPACK_IMPORTED_MODULE_4__["default"])([path, append]);
    }
  }, {
    ...
    value: function orderIds(ids, entities) {
      if (this.orderBy) {
        return lodash_sortBy__WEBPACK_IMPORTED_MODULE_1___default()(ids, id => {
    ...
    value: function getNormalizedDataFrom(entityOrEntities) {
      return Object(_libs_normalize__WEBPACK_IMPORTED_MODULE_3__["default"])(entityOrEntities, this.getCollectionSchema(), this.getMainSchema());
    }
  }, {
    key: "reducer",
    value: function reducer(state, action = {}) {
      ...
      switch (action.type) {
        ...
        case SET_ENTITIES:
          ...
          _libs_logger__WEBPACK_IMPORTED_MODULE_2__["default"].debug(`${SET_ENTITIES}:${this.schema.collection}`, action.normalizedData[this.schema.collection]);
          finalStateBeforeOrdering = Object(_libs_normalizedMerge__WEBPACK_IMPORTED_MODULE_6__["default"])(state, {
        ...
        case SET_ENTITIES_FROM_STATE:
          ...
          _libs_logger__WEBPACK_IMPORTED_MODULE_2__["default"].debug(`${SET_ENTITIES_FROM_STATE}:${collection}`, action.normalizedData[collection]);
          finalStateBeforeOrdering = Object(_libs_normalizedMerge__WEBPACK_IMPORTED_MODULE_6__["default"])(state, action.normalizedData[collection]);
          return { ...finalStateBeforeOrdering,
            ids: this.orderIds(finalStateBeforeOrdering.ids, finalStateBeforeOrdering.entities)
          };
        //
    ...
    value: function processApiRequest({
      ...
      _libs_logger__WEBPACK_IMPORTED_MODULE_2__["default"].log(`ReducksBaseCollection:${this.constructor.name}:processApiRequest`);
      return { ...state,
        isLoading: true
      };
    }
    ...
    value: function processApiSuccess({
      ...
      _libs_logger__WEBPACK_IMPORTED_MODULE_2__["default"].log(`ReducksBaseCollection:${this.constructor.name}:processApiSuccess`);
      ...
      if (!action.payload.data.id && !lodash_isArray__WEBPACK_IMPORTED_MODULE_0___default()(action.payload.data)) {
        // An entity was probably deleted, but there might be other
        // models or collections of models, so check before continuing.
        if (action.payload.data && lodash_isArray__WEBPACK_IMPORTED_MODULE_0___default()(this.getCollectionSchema().nested)) {
          this.getCollectionSchema().nested.forEach(nestedSchema => {
            ...
            if (action.payload.data[nestedSchema.key]) {
              ...
              const normalizedData = Object(_libs_normalize__WEBPACK_IMPORTED_MODULE_3__["default"])(action.payload.data[nestedSchema.key], relationsSchema, this.getMainSchema());
      ...
      const normalizedData = Object(_libs_normalize__WEBPACK_IMPORTED_MODULE_3__["default"])(action.payload.data, this.getCollectionSchema(), this.getMainSchema());
      action.asyncDispatch(setEntities(normalizedData)); // Fist, merge the newState into the old state

      let newState = Object(_libs_normalizedMerge__WEBPACK_IMPORTED_MODULE_6__["default"])(state, {
      ...
      const finalStateBeforeOrdering = Object(_libs_normalizedMerge__WEBPACK_IMPORTED_MODULE_6__["default"])(newState, dataTransformer(normalizedData, newState));
      return { ...finalStateBeforeOrdering,
        ids: this.orderIds(finalStateBeforeOrdering.ids, finalStateBeforeOrdering.entities)
      };
    }
    ...
    value: function processApiFailure({
      ...
      _libs_logger__WEBPACK_IMPORTED_MODULE_2__["default"].log(`ReducksBaseCollection:${this.constructor.name}:processApiFailure`);
      return { ...state,
        isLoading: false,
    ...
    value: function removeEntityById(state, entityToDeleteId) {
      _libs_logger__WEBPACK_IMPORTED_MODULE_2__["default"].log(`ReducksBaseCollection:${this.constructor.name}:removeEntityById:${entityToDeleteId}`);
    ...
    value: function removeEntitiesById(state, entityIdsToDelete) {
      _libs_logger__WEBPACK_IMPORTED_MODULE_2__["default"].log(`ReducksBaseCollection:${this.constructor.name}:removeEntityById:${entityIdsToDelete}`);
      let updatedEntities = {};
      let updatedIds = [];
...
/* harmony import */ var _libs_shared__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../libs/shared */ "./src/libs/shared.js");
...
/* harmony default export */ __webpack_exports__["default"] = ((...collections) => {
  ...
  if (lodash_isArray__WEBPACK_IMPORTED_MODULE_1___default()(collections[0])) {
    collections = collections[0];
  }

  _libs_shared__WEBPACK_IMPORTED_MODULE_3__["default"].collections = collections;
  const reducersHash = {};
  collections.forEach(collection => {
    // Error check
    if (!collection.schema || !lodash_isObject__WEBPACK_IMPORTED_MODULE_2___default()(collection.schema) || !collection.schema.collection) {
      throw new TypeError('Collection#schema should be an object in the format { collection: "users", ... }. See docs for more options');
    }

    if (!collection.reducer || !lodash_isFunction__WEBPACK_IMPORTED_MODULE_0___default()(collection.reducer)) {
